...
public class ProductServiceTest {
	...
	//==>@RunWith,@ContextConfiguration ¿ÃøÎ Wiring, Test «“ instance DI
		...
		public void testGetProduct() throws Exception {
			...
			Assert.assertEquals("πŒ¿Á", product.getProdName());
			Assert.assertEquals("∑Í∑Á∑Í∑Á", product.getProdDetail());
			Assert.assertEquals("20240301", product.getManuDate());
			Assert.assertEquals(4320, product.getPrice());
...
//			Assert.assertEquals("testFileName", product.getFileName());
			...
			product.setProdName("πŒ¿Á");
			product.setProdDetail("∑Í∑Á∑Í∑Á");
